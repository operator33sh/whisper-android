package com.whisper.android.ui.privatefeed
...
@Composable
fun PrivateFeedScreen(vm: PrivateFeedViewModel = viewModel()) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text("Following", fontWeight = FontWeight.Bold, color = Color.Black)
                },
                actions = {
                    BlueGlowIndicator(
        ...
        if (posts.isEmpty()) {
            Box(
                ...
                Text(
                    text = "Follow someone on the Public feed to see their posts here.",
            ...
            LazyColumn(
                ...
                items(posts, key = { it.id }) { post ->
                    PostCard(
                        post = post,
                        isFollowing = vm.isFollowing(post.authorPubkey),
